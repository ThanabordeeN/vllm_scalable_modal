...
MODEL_REVISION = "9cbb7d095de14228cf522efcebaad4c9245ec98b"
...
try:
    volume = modal.Volume.lookup("THAT_GPT_MODELS", create_if_missing=False)
...
app = modal.App("THAI-GPT-7B-vLLM-OpenAI-Compatible")
